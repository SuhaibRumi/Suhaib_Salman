...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Suhaib Salman",
          from_email: form.email,
          to_email: "suhiabsohan007@gmail.com",
  ...
  return (
    <div
      className={`xl:mt-12 flex 2xl:flex-row flex-col gap-5 overflow-hidden`}
    >
      <motion.div
      ...
      >
        ...
        <div className="mt-5 contact__options">
          <article className="contact__option">
            <MdEmail />
            <a
              href="mailto:suhaibsohan007@gmail.com "
              target="_blank"
              className="blue-text-gradient"
            >
              suhaibsohan007@gmail.com
            </a>
          </article>
          <article className="contact__option">
            <BsWhatsapp />
            <a
              href="https://api.whatsapp.com/send/?phone=923226998373&text&app_absent=0&lang=en"
              target="_blank"
              className="blue-text-gradient"
            >
              +92 3226998373
